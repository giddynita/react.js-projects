...
export const loader = ({ params }) => {
  ...
  const selectedSubCategory = productList.filter(
    (product) => product.subCategory === subcategory
  )
  const selectedCategory = productList.filter(
    (product) => product.category === category
  )
  return { selectedSubCategory, selectedCategory, subcategory, category }
}

const SubCategory = () => {
  const { selectedSubCategory, selectedCategory, subcategory, category } =
    useLoaderData()
  ...
  const searchAndPriceFiltered = selectedSubCategory
